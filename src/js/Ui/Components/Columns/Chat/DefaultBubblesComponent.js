...
// class DefaultdBubblesComponent extends StatelessComponent {
//     bubblesInnerRef = VComponent.createRef();
//
//     isLoadingRecent = false;
//     mainVirtual: VirtualMessages = new VirtualMessages({size: 30});
//     secondVirtual: VirtualMessages = new VirtualMessages({size: 30});
//
...
//
//     refresh = () => {
//         // this.bubblesInnerRef.$el.style.display = "none";
//         this.cleanupTree();
//         this.mainVirtual.refresh();
//         this.secondVirtual.refresh();
//         // this.bubblesInnerRef.$el.style.display = "flex";
...
//         const clientHeight = this.bubblesInnerRef.$el.clientHeight;
//
...
//             this.$el.scrollTop = scrollTop + this.bubblesInnerRef.$el.clientHeight - clientHeight;
//         }
//     }
//
...
//         // }
//
//         if (this.isUsingSecondVirtual && this.currentVirtual.isVeryBottom()) {
...
//         return !this.isUsingSecondVirtual
//         // && this.mainVirtual.isVeryBottom();
//     }
//
//     dev_checkTree = () => {
//         if (__IS_DEV__) {
...
// }
//
// export default DefaultdBubblesComponent;